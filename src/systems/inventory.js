...
export class InventorySystem {
    ...
    generateItem(itemType, floor = 1, rarity = null) {
        ...
        const localization = this.game.getSystem('localization');
    ...
    showTooltip(event, item) {
        ...
        const lang = this.game.getSystem('localization').getCurrentLanguage();
