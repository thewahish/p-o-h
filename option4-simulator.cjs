#!/usr/bin/env node
/**
 * OPTION 4 BALANCE SIMULATOR - Moderate Difficulty
 *
 * Testing more balanced approach:
 * - 2 starting potions (100 HP emergency healing)
 * - Moderate XP curve (70 + level*50)
 * - Moderate enemy buffs (+20% HP, +20% ATK)
...
console.log('🎮 OPTION 4 SIMULATOR - Moderate Difficulty');
console.log('Testing balanced roguelike progression\n');
...
function xpForLevel(level) {
    return 70 + (level - 1) * 50; // Moderate leveling (Option 4)
}
...
console.log('\n🎮 PLAYER JOURNEY: Testing Option 4 balance...\n');
...
// ===== FINAL ANALYSIS =====
console.log('\n' + '='.repeat(70));
console.log('📊 OPTION 4 ANALYSIS - MODERATE DIFFICULTY\n');
...
if (fullComplete) {
    ...
    if (hours < 4) {
        ...
        console.log(`✅ PERFECT LENGTH! (${hours}h to completion - Target: 6-10h)`);
    } else {
